...
ALTER TABLE DPM_ROLE ADD CONSTRAINT DPM_ROLE_DF_RECORD_DATE
...
ALTER TABLE DPM_RESOURCE ADD CONSTRAINT DPM_RESOURCE_DF_RECORD_DATE
DEFAULT (getdate()) FOR RECORD_DATE;
...
ALTER TABLE DPM_USER ADD CONSTRAINT DPM_USER_DF_RECORD_DATE
DEFAULT (getdate()) FOR RECORD_DATE;
