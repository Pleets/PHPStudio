...
ALTER TABLE APP_ROLE ADD CONSTRAINT APP_ROLE_DF_RECORD_DATE
...
ALTER TABLE APP_RESOURCE ADD CONSTRAINT APP_RESOURCE_DF_RECORD_DATE
DEFAULT (getdate()) FOR RECORD_DATE;
...
ALTER TABLE APP_USER ADD CONSTRAINT APP_USER_DF_RECORD_DATE
DEFAULT (getdate()) FOR RECORD_DATE;
